...
async function startServer() {
  ...
  // Enable CORS so Android APK / external clients can query the API
  ...
  // YouTube Real Video ID Resolver Endpoint
  app.get('/api/yt-search', async (req, res) => {
    ...
    try {
      // 1. Direct YouTube HTML Search Query
    ...
    // 2. Intelligent Fallback with Gemini Model
    try {
